...
?DOC(false).
-spec add_date_header(gleam@http@response:response(XDY)) -> gleam@http@response:response(XDY).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(XEB)) -> gleam@http@response:response(XEB).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(XEE)) -> gleam@http@response:response(XEE).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(XEH)) -> gleam@http@response:response(XEH).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(XEM)) -> gleam@http@response:response(XEM)).
