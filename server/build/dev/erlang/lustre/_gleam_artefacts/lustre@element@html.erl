...
?DOC("\n").
-spec html(
    list(lustre@vdom@vattr:attribute(OHJ)),
    list(lustre@vdom@vnode:element(OHJ))
) -> lustre@vdom@vnode:element(OHJ).
html(Attrs, Children) ->
...
?DOC("\n").
-spec base(list(lustre@vdom@vattr:attribute(OHR))) -> lustre@vdom@vnode:element(OHR).
base(Attrs) ->
...
?DOC("\n").
-spec link(list(lustre@vdom@vattr:attribute(OIB))) -> lustre@vdom@vnode:element(OIB).
link(Attrs) ->
    lustre@element:element(<<"link"/utf8>>, Attrs, []).

-file("src/lustre/element/html.gleam", 43).
?DOC("\n").
-spec meta(list(lustre@vdom@vattr:attribute(OIF))) -> lustre@vdom@vnode:element(OIF).
meta(Attrs) ->
    lustre@element:element(<<"meta"/utf8>>, Attrs, []).

-file("src/lustre/element/html.gleam", 48).
?DOC("\n").
-spec style(list(lustre@vdom@vattr:attribute(OIJ)), binary()) -> lustre@vdom@vnode:element(OIJ).
style(Attrs, Css) ->
    lustre@element:unsafe_raw_html(<<""/utf8>>, <<"style"/utf8>>, Attrs, Css).

-file("src/lustre/element/html.gleam", 53).
?DOC("\n").
-spec title(list(lustre@vdom@vattr:attribute(OIN)), binary()) -> lustre@vdom@vnode:element(OIN).
title(Attrs, Content) ->
...
?DOC("\n").
-spec body(
    list(lustre@vdom@vattr:attribute(OIR)),
    list(lustre@vdom@vnode:element(OIR))
) -> lustre@vdom@vnode:element(OIR).
body(Attrs, Children) ->
...
?DOC("\n").
-spec address(
    list(lustre@vdom@vattr:attribute(OIX)),
    list(lustre@vdom@vnode:element(OIX))
) -> lustre@vdom@vnode:element(OIX).
...
?DOC("\n").
-spec article(
    list(lustre@vdom@vattr:attribute(OJD)),
    list(lustre@vdom@vnode:element(OJD))
) -> lustre@vdom@vnode:element(OJD).
...
-spec aside(
    ...
    list(lustre@vdom@vnode:element(OJJ))
) -> lustre@vdom@vnode:element(OJJ).
...
?DOC("\n").
-spec footer(
    list(lustre@vdom@vattr:attribute(OJP)),
    list(lustre@vdom@vnode:element(OJP))
...
?DOC("\n").
-spec header(
    list(lustre@vdom@vattr:attribute(OJV)),
    list(lustre@vdom@vnode:element(OJV))
) -> lustre@vdom@vnode:element(OJV).
...
?DOC("\n").
-spec h1(
    list(lustre@vdom@vattr:attribute(OKB)),
    list(lustre@vdom@vnode:element(OKB))
) -> lustre@vdom@vnode:element(OKB).
h1(Attrs, Children) ->
...
?DOC("\n").
-spec h2(
    list(lustre@vdom@vattr:attribute(OKH)),
    list(lustre@vdom@vnode:element(OKH))
) -> lustre@vdom@vnode:element(OKH).
h2(Attrs, Children) ->
...
?DOC("\n").
-spec h3(
    list(lustre@vdom@vattr:attribute(OKN)),
    list(lustre@vdom@vnode:element(OKN))
...
?DOC("\n").
-spec h4(
    list(lustre@vdom@vattr:attribute(OKT)),
    list(lustre@vdom@vnode:element(OKT))
) -> lustre@vdom@vnode:element(OKT).
h4(Attrs, Children) ->
...
?DOC("\n").
-spec main(
    list(lustre@vdom@vattr:attribute(OLR)),
    list(lustre@vdom@vnode:element(OLR))
) -> lustre@vdom@vnode:element(OLR).
main(Attrs, Children) ->
...
?DOC("\n").
-spec nav(
    list(lustre@vdom@vattr:attribute(OLX)),
    list(lustre@vdom@vnode:element(OLX))
) -> lustre@vdom@vnode:element(OLX).
nav(Attrs, Children) ->
...
?DOC("\n").
-spec section(
    list(lustre@vdom@vattr:attribute(OMD)),
    list(lustre@vdom@vnode:element(OMD))
) -> lustre@vdom@vnode:element(OMD).
...
?DOC("\n").
-spec search(
    list(lustre@vdom@vattr:attribute(OMJ)),
    list(lustre@vdom@vnode:element(OMJ))
) -> lustre@vdom@vnode:element(OMJ).
...
?DOC("\n").
-spec blockquote(
    list(lustre@vdom@vattr:attribute(OMP)),
    list(lustre@vdom@vnode:element(OMP))
) -> lustre@vdom@vnode:element(OMP).
...
?DOC("\n").
-spec dd(
    list(lustre@vdom@vattr:attribute(OMV)),
    list(lustre@vdom@vnode:element(OMV))
) -> lustre@vdom@vnode:element(OMV).
dd(Attrs, Children) ->
...
?DOC("\n").
-spec 'div'(
    list(lustre@vdom@vattr:attribute(ONB)),
    list(lustre@vdom@vnode:element(ONB))
) -> lustre@vdom@vnode:element(ONB).
'div'(Attrs, Children) ->
...
?DOC("\n").
-spec dl(
    list(lustre@vdom@vattr:attribute(ONH)),
    list(lustre@vdom@vnode:element(ONH))
) -> lustre@vdom@vnode:element(ONH).
dl(Attrs, Children) ->
...
?DOC("\n").
-spec dt(
    list(lustre@vdom@vattr:attribute(ONN)),
    list(lustre@vdom@vnode:element(ONN))
) -> lustre@vdom@vnode:element(ONN).
dt(Attrs, Children) ->
...
?DOC("\n").
-spec figcaption(
    list(lustre@vdom@vattr:attribute(ONT)),
    list(lustre@vdom@vnode:element(ONT))
) -> lustre@vdom@vnode:element(ONT).
...
?DOC("\n").
-spec figure(
    list(lustre@vdom@vattr:attribute(ONZ)),
    list(lustre@vdom@vnode:element(ONZ))
) -> lustre@vdom@vnode:element(ONZ).
figure(Attrs, Children) ->
    lustre@element:element(<<"figure"/utf8>>, Attrs, Children).

-file("src/lustre/element/html.gleam", 256).
?DOC("\n").
-spec hr(list(lustre@vdom@vattr:attribute(OOF))) -> lustre@vdom@vnode:element(OOF).
hr(Attrs) ->
...
?DOC("\n").
-spec li(
    list(lustre@vdom@vattr:attribute(OOJ)),
    list(lustre@vdom@vnode:element(OOJ))
) -> lustre@vdom@vnode:element(OOJ).
li(Attrs, Children) ->
...
-spec menu(
    ...
    list(lustre@vdom@vnode:element(OOP))
) -> lustre@vdom@vnode:element(OOP).
menu(Attrs, Children) ->
...
?DOC("\n").
-spec ol(
    list(lustre@vdom@vattr:attribute(OOV)),
    list(lustre@vdom@vnode:element(OOV))
) -> lustre@vdom@vnode:element(OOV).
ol(Attrs, Children) ->
...
?DOC("\n").
-spec p(
    list(lustre@vdom@vattr:attribute(OPB)),
    list(lustre@vdom@vnode:element(OPB))
) -> lustre@vdom@vnode:element(OPB).
p(Attrs, Children) ->
...
-spec pre(
    ...
    list(lustre@vdom@vnode:element(OPH))
) -> lustre@vdom@vnode:element(OPH).
pre(Attrs, Children) ->
...
?DOC("\n").
-spec ul(
    list(lustre@vdom@vattr:attribute(OPN)),
    list(lustre@vdom@vnode:element(OPN))
) -> lustre@vdom@vnode:element(OPN).
ul(Attrs, Children) ->
...
?DOC("\n").
-spec a(
    list(lustre@vdom@vattr:attribute(OPT)),
    list(lustre@vdom@vnode:element(OPT))
) -> lustre@vdom@vnode:element(OPT).
a(Attrs, Children) ->
...
?DOC("\n").
-spec abbr(
    list(lustre@vdom@vattr:attribute(OPZ)),
    list(lustre@vdom@vnode:element(OPZ))
) -> lustre@vdom@vnode:element(OPZ).
abbr(Attrs, Children) ->
...
?DOC("\n").
-spec b(
    list(lustre@vdom@vattr:attribute(OQF)),
    list(lustre@vdom@vnode:element(OQF))
) -> lustre@vdom@vnode:element(OQF).
b(Attrs, Children) ->
...
?DOC("\n").
-spec bdi(
    list(lustre@vdom@vattr:attribute(OQL)),
    list(lustre@vdom@vnode:element(OQL))
) -> lustre@vdom@vnode:element(OQL).
bdi(Attrs, Children) ->
...
?DOC("\n").
-spec br(list(lustre@vdom@vattr:attribute(OQX))) -> lustre@vdom@vnode:element(OQX).
br(Attrs) ->
...
?DOC("\n").
-spec cite(
    list(lustre@vdom@vattr:attribute(ORB)),
    list(lustre@vdom@vnode:element(ORB))
) -> lustre@vdom@vnode:element(ORB).
cite(Attrs, Children) ->
...
-spec code(
    ...
    list(lustre@vdom@vnode:element(ORH))
) -> lustre@vdom@vnode:element(ORH).
code(Attrs, Children) ->
...
?DOC("\n").
-spec data(
    list(lustre@vdom@vattr:attribute(ORN)),
    list(lustre@vdom@vnode:element(ORN))
) -> lustre@vdom@vnode:element(ORN).
data(Attrs, Children) ->
...
?DOC("\n").
-spec dfn(
    list(lustre@vdom@vattr:attribute(ORT)),
    list(lustre@vdom@vnode:element(ORT))
) -> lustre@vdom@vnode:element(ORT).
dfn(Attrs, Children) ->
...
?DOC("\n").
-spec em(
    list(lustre@vdom@vattr:attribute(ORZ)),
    list(lustre@vdom@vnode:element(ORZ))
) -> lustre@vdom@vnode:element(ORZ).
em(Attrs, Children) ->
...
?DOC("\n").
-spec i(
    list(lustre@vdom@vattr:attribute(OSF)),
    list(lustre@vdom@vnode:element(OSF))
) -> lustre@vdom@vnode:element(OSF).
i(Attrs, Children) ->
...
?DOC("\n").
-spec kbd(
    list(lustre@vdom@vattr:attribute(OSL)),
    list(lustre@vdom@vnode:element(OSL))
) -> lustre@vdom@vnode:element(OSL).
kbd(Attrs, Children) ->
...
?DOC("\n").
-spec mark(
    list(lustre@vdom@vattr:attribute(OSR)),
    list(lustre@vdom@vnode:element(OSR))
) -> lustre@vdom@vnode:element(OSR).
mark(Attrs, Children) ->
...
?DOC("\n").
-spec q(
    list(lustre@vdom@vattr:attribute(OSX)),
    list(lustre@vdom@vnode:element(OSX))
) -> lustre@vdom@vnode:element(OSX).
q(Attrs, Children) ->
...
?DOC("\n").
-spec rp(
    list(lustre@vdom@vattr:attribute(OTD)),
    list(lustre@vdom@vnode:element(OTD))
) -> lustre@vdom@vnode:element(OTD).
rp(Attrs, Children) ->
...
?DOC("\n").
-spec rt(
    list(lustre@vdom@vattr:attribute(OTJ)),
    list(lustre@vdom@vnode:element(OTJ))
) -> lustre@vdom@vnode:element(OTJ).
rt(Attrs, Children) ->
...
?DOC("\n").
-spec samp(
    list(lustre@vdom@vattr:attribute(OUB)),
    list(lustre@vdom@vnode:element(OUB))
) -> lustre@vdom@vnode:element(OUB).
samp(Attrs, Children) ->
...
?DOC("\n").
-spec small(
    list(lustre@vdom@vattr:attribute(OUH)),
    list(lustre@vdom@vnode:element(OUH))
) -> lustre@vdom@vnode:element(OUH).
...
?DOC("\n").
-spec span(
    list(lustre@vdom@vattr:attribute(OUN)),
    list(lustre@vdom@vnode:element(OUN))
) -> lustre@vdom@vnode:element(OUN).
span(Attrs, Children) ->
...
?DOC("\n").
-spec strong(
    list(lustre@vdom@vattr:attribute(OUT)),
    list(lustre@vdom@vnode:element(OUT))
) -> lustre@vdom@vnode:element(OUT).
...
?DOC("\n").
-spec sub(
    list(lustre@vdom@vattr:attribute(OUZ)),
    list(lustre@vdom@vnode:element(OUZ))
) -> lustre@vdom@vnode:element(OUZ).
sub(Attrs, Children) ->
...
?DOC("\n").
-spec sup(
    list(lustre@vdom@vattr:attribute(OVF)),
    list(lustre@vdom@vnode:element(OVF))
) -> lustre@vdom@vnode:element(OVF).
sup(Attrs, Children) ->
...
?DOC("\n").
-spec time(
    list(lustre@vdom@vattr:attribute(OVL)),
    list(lustre@vdom@vnode:element(OVL))
) -> lustre@vdom@vnode:element(OVL).
time(Attrs, Children) ->
...
?DOC("\n").
-spec u(
    list(lustre@vdom@vattr:attribute(OVR)),
    list(lustre@vdom@vnode:element(OVR))
) -> lustre@vdom@vnode:element(OVR).
u(Attrs, Children) ->
...
?DOC("\n").
-spec var(
    list(lustre@vdom@vattr:attribute(OVX)),
    list(lustre@vdom@vnode:element(OVX))
) -> lustre@vdom@vnode:element(OVX).
var(Attrs, Children) ->
    lustre@element:element(<<"var"/utf8>>, Attrs, Children).

-file("src/lustre/element/html.gleam", 532).
?DOC("\n").
-spec wbr(list(lustre@vdom@vattr:attribute(OWD))) -> lustre@vdom@vnode:element(OWD).
wbr(Attrs) ->
    lustre@element:element(<<"wbr"/utf8>>, Attrs, []).

-file("src/lustre/element/html.gleam", 539).
?DOC("\n").
-spec area(list(lustre@vdom@vattr:attribute(OWH))) -> lustre@vdom@vnode:element(OWH).
area(Attrs) ->
...
?DOC("\n").
-spec audio(
    list(lustre@vdom@vattr:attribute(OWL)),
    list(lustre@vdom@vnode:element(OWL))
) -> lustre@vdom@vnode:element(OWL).
audio(Attrs, Children) ->
    lustre@element:element(<<"audio"/utf8>>, Attrs, Children).

-file("src/lustre/element/html.gleam", 552).
?DOC("\n").
-spec img(list(lustre@vdom@vattr:attribute(OWR))) -> lustre@vdom@vnode:element(OWR).
img(Attrs) ->
...
-spec map(
    list(lustre@vdom@vattr:attribute(OWV)),
    list(lustre@vdom@vnode:element(OWV))
) -> lustre@vdom@vnode:element(OWV).
map(Attrs, Children) ->
    lustre@element:element(<<"map"/utf8>>, Attrs, Children).

-file("src/lustre/element/html.gleam", 566).
?DOC("\n").
-spec track(list(lustre@vdom@vattr:attribute(OXB))) -> lustre@vdom@vnode:element(OXB).
track(Attrs) ->
...
?DOC("\n").
-spec video(
    list(lustre@vdom@vattr:attribute(OXF)),
    list(lustre@vdom@vnode:element(OXF))
) -> lustre@vdom@vnode:element(OXF).
video(Attrs, Children) ->
    lustre@element:element(<<"video"/utf8>>, Attrs, Children).

-file("src/lustre/element/html.gleam", 581).
?DOC("\n").
-spec embed(list(lustre@vdom@vattr:attribute(OXL))) -> lustre@vdom@vnode:element(OXL).
embed(Attrs) ->
    lustre@element:element(<<"embed"/utf8>>, Attrs, []).

-file("src/lustre/element/html.gleam", 586).
?DOC("\n").
-spec iframe(list(lustre@vdom@vattr:attribute(OXP))) -> lustre@vdom@vnode:element(OXP).
iframe(Attrs) ->
    lustre@element:element(<<"iframe"/utf8>>, Attrs, []).

-file("src/lustre/element/html.gleam", 591).
?DOC("\n").
-spec object(list(lustre@vdom@vattr:attribute(OXT))) -> lustre@vdom@vnode:element(OXT).
object(Attrs) ->
...
-spec picture(
    ...
    list(lustre@vdom@vnode:element(OXX))
...
?DOC("\n").
-spec portal(list(lustre@vdom@vattr:attribute(OYD))) -> lustre@vdom@vnode:element(OYD).
portal(Attrs) ->
    lustre@element:element(<<"portal"/utf8>>, Attrs, []).

-file("src/lustre/element/html.gleam", 609).
?DOC("\n").
-spec source(list(lustre@vdom@vattr:attribute(OYH))) -> lustre@vdom@vnode:element(OYH).
source(Attrs) ->
...
?DOC("\n").
-spec canvas(list(lustre@vdom@vattr:attribute(OYX))) -> lustre@vdom@vnode:element(OYX).
canvas(Attrs) ->
...
?DOC("\n").
-spec script(list(lustre@vdom@vattr:attribute(OZH)), binary()) -> lustre@vdom@vnode:element(OZH).
script(Attrs, Js) ->
...
-spec del(
    ...
    list(lustre@vdom@vnode:element(OZL))
...
?DOC("\n").
-spec ins(
    list(lustre@vdom@vattr:attribute(OZR)),
    list(lustre@vdom@vnode:element(OZR))
) -> lustre@vdom@vnode:element(OZR).
ins(Attrs, Children) ->
...
?DOC("\n").
-spec caption(
    list(lustre@vdom@vattr:attribute(OZX)),
    list(lustre@vdom@vnode:element(OZX))
) -> lustre@vdom@vnode:element(OZX).
caption(Attrs, Children) ->
    lustre@element:element(<<"caption"/utf8>>, Attrs, Children).

-file("src/lustre/element/html.gleam", 680).
?DOC("\n").
-spec col(list(lustre@vdom@vattr:attribute(PAD))) -> lustre@vdom@vnode:element(PAD).
col(Attrs) ->
...
?DOC("\n").
-spec input(list(lustre@vdom@vattr:attribute(PDB))) -> lustre@vdom@vnode:element(PDB).
input(Attrs) ->
...
?DOC("\n").
-spec option(list(lustre@vdom@vattr:attribute(PED)), binary()) -> lustre@vdom@vnode:element(PED).
option(Attrs, Label) ->
...
?DOC("\n").
-spec textarea(list(lustre@vdom@vattr:attribute(PEZ)), binary()) -> lustre@vdom@vnode:element(PEZ).
...
?DOC("\n").
-spec details(
    list(lustre@vdom@vattr:attribute(PFD)),
    list(lustre@vdom@vnode:element(PFD))
) -> lustre@vdom@vnode:element(PFD).
...
?DOC("\n").
-spec dialog(
    list(lustre@vdom@vattr:attribute(PFJ)),
    list(lustre@vdom@vnode:element(PFJ))
) -> lustre@vdom@vnode:element(PFJ).
...
?DOC("\n").
-spec summary(
    list(lustre@vdom@vattr:attribute(PFP)),
    list(lustre@vdom@vnode:element(PFP))
) -> lustre@vdom@vnode:element(PFP).
...
?DOC("\n").
-spec slot(
    list(lustre@vdom@vattr:attribute(PFV)),
    list(lustre@vdom@vnode:element(PFV))
) -> lustre@vdom@vnode:element(PFV).
slot(Attrs, Fallback) ->
