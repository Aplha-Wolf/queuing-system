...
-type client_message(PSJ) :: {mount,
        ...
        lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(PSJ)), lustre@vdom@vnode:element(PSJ))} |
    {reconcile,
        integer(),
        lustre@vdom@patch:patch(PSJ),
        lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(PSJ)), lustre@vdom@vnode:element(PSJ))} |
...
-spec mount_to_json(
    ...
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(PTJ)), lustre@vdom@vnode:element(PTJ))
) -> gleam@json:json().
mount_to_json(
    Kind,
    Open_shadow_root,
...
-spec reconcile_to_json(
    integer(),
    lustre@vdom@patch:patch(PTM),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(PTM)), lustre@vdom@vnode:element(PTM))
) -> gleam@json:json().
...
-spec mount(
    ...
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(PSP)), lustre@vdom@vnode:element(PSP))
) -> client_message(PSP).
mount(
    Open_shadow_root,
    Will_adopt_styles,
...
?DOC(false).
-spec reconcile(
    lustre@vdom@patch:patch(PST),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(PST)), lustre@vdom@vnode:element(PST))
) -> client_message(PST).
