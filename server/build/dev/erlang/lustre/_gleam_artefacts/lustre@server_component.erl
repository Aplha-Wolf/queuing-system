...
-spec element(
    list(lustre@vdom@vattr:attribute(VQK)),
    list(lustre@vdom@vnode:element(VQK))
) -> lustre@vdom@vnode:element(VQK).
...
-spec include(lustre@vdom@vattr:attribute(VQW), list(binary())) -> lustre@vdom@vattr:attribute(VQW).
...
-spec subject(lustre:runtime(VRA)) -> gleam@erlang@process:subject(lustre@runtime@server@runtime:message(VRA)).
subject(Runtime) ->
...
-spec register_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(VRI))
) -> lustre@runtime@server@runtime:message(VRI).
...
-spec deregister_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(VRM))
) -> lustre@runtime@server@runtime:message(VRM).
...
-spec register_callback(
    fun((lustre@runtime@transport:client_message(VRQ)) -> nil)
) -> lustre@runtime@server@runtime:message(VRQ).
...
-spec deregister_callback(
    fun((lustre@runtime@transport:client_message(VRT)) -> nil)
) -> lustre@runtime@server@runtime:message(VRT).
...
-spec select(
    fun((fun((VRY) -> nil), gleam@erlang@process:subject(any())) -> gleam@erlang@process:selector(VRY))
) -> lustre@effect:effect(VRY).
select(Sel) ->
