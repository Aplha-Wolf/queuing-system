...
-spec find_matching_in_list(
    ...
    integer()
) -> {ok, {lustre@vdom@vnode:element(TKN), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_direct_child(
    lustre@vdom@vnode:element(TKI),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(TKI), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_all_direct_children(lustre@vdom@vnode:element(TLR), selector()) -> list(lustre@vdom@vnode:element(TLR)).
...
-spec find_all_in_list(list(lustre@vdom@vnode:element(TLM)), 'query'()) -> list(lustre@vdom@vnode:element(TLM)).
...
-spec find_all(lustre@vdom@vnode:element(TLE), 'query'()) -> list(lustre@vdom@vnode:element(TLE)).
find_all(Root, Query) ->
    case Query of
        {find_element, Selector} ->
...
-spec find_all_in_children(lustre@vdom@vnode:element(TLI), 'query'()) -> list(lustre@vdom@vnode:element(TLI)).
...
-spec find_all_descendants_in_list(
    list(lustre@vdom@vnode:element(TME)),
    selector()
) -> list(lustre@vdom@vnode:element(TME)).
...
-spec find_all_descendants(lustre@vdom@vnode:element(TMA), selector()) -> list(lustre@vdom@vnode:element(TMA)).
...
-spec find_in_list(
    list(lustre@vdom@vnode:element(TKC)),
    'query'(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(TKC), lustre@vdom@path:path()}} |
    {error, nil}.
...
?DOC(false).
-spec find_path(
    lustre@vdom@vnode:element(TJS),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(TJS), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_in_children(
    lustre@vdom@vnode:element(TJX),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(TJX), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find(lustre@vdom@vnode:element(TJN), 'query'()) -> {ok,
...
-spec find_descendant_in_list(
    list(lustre@vdom@vnode:element(TKY)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(TKY), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_descendant(
    lustre@vdom@vnode:element(TKT),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(TKT), lustre@vdom@path:path()}} |
    {error, nil}.
