...
```
queuing-system/
├── priv/         # Static assets (compiled client JS, CSS, HTML)
├── src/          # Application source code
│   ├── apps/     # Bounded contexts (terminal, frontdesk, display, settings)
│   ├── repository/  # Database queries
│   ├── shared_kernel/ # Domain types
...
The server listens on port 3001. Open your browser to:
...
If port 3001 is already in use, you can change it in `src/server.gleam`:
