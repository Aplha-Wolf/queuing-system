...
-type pool(MVE, MVF) :: {pool,
        fun((MVE, glisten@internal@handler:loop_message(MVF), glisten@internal@handler:connection(MVF)) -> glisten@internal@handler:next(MVE, glisten@internal@handler:loop_message(MVF))),
        integer(),
        fun((glisten@internal@handler:connection(MVF)) -> {MVE,
            gleam@option:option(gleam@erlang@process:selector(MVF))}),
        gleam@option:option(fun((MVE) -> nil)),
        glisten@transport:transport()}.
