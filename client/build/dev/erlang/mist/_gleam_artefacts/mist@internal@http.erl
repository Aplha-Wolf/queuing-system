...
?DOC(false).
-spec add_date_header(gleam@http@response:response(YDL)) -> gleam@http@response:response(YDL).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(YDO)) -> gleam@http@response:response(YDO).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(YDR)) -> gleam@http@response:response(YDR).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(YDU)) -> gleam@http@response:response(YDU).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(YDZ)) -> gleam@http@response:response(YDZ)).
