...
-export_type([digest_algorithm/0, crypto_key/0, format/0, public_key_algorithm/0, key_usage/0, import_algorithm/0, named_curve/0, sign_algorithm/0]).

-type digest_algorithm() :: s_h_a1 | s_h_a256 | s_h_a384 | s_h_a512.

-type crypto_key() :: any().

-type format() :: raw | pkcs8 | spki.
...
-file("src/plinth/browser/crypto/subtle.gleam", 40).
...
-file("src/plinth/browser/crypto/subtle.gleam", 102).
...
-file("src/plinth/browser/crypto/subtle.gleam", 184).
...
-file("src/plinth/browser/crypto/subtle.gleam", 157).
...
-file("src/plinth/browser/crypto/subtle.gleam", 212).
