...
-type credential(AKMU) :: any() | {gleam_phantom, AKMU}.

-type attest() :: any().

-type assertion() :: any().

-file("src/plinth/browser/credentials/public_key.gleam", 48).
?DOC(
...
-file("src/plinth/browser/credentials/public_key.gleam", 87).
-spec request(bitstring()) -> request_options().
request(Challenge) ->
    {request_options, [], Challenge, [], none, none, preferred}.

-file("src/plinth/browser/credentials/public_key.gleam", 98).
...
-file("src/plinth/browser/credentials/public_key.gleam", 112).
...
-file("src/plinth/browser/credentials/public_key.gleam", 125).
...
-file("src/plinth/browser/credentials/public_key.gleam", 139).
...
-file("src/plinth/browser/credentials/public_key.gleam", 156).
...
-file("src/plinth/browser/credentials/public_key.gleam", 173).
...
-file("src/plinth/browser/credentials/public_key.gleam", 194).
-spec json_bitarry(bitstring()) -> gleam@json:json().
json_bitarry(Bytes) ->
    gleam@json:string(gleam@bit_array:base64_url_encode(Bytes, false)).

-file("src/plinth/browser/credentials/public_key.gleam", 287).
