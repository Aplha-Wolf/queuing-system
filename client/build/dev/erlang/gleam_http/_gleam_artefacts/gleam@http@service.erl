...
-spec map_response_body(
    fun((GGC) -> gleam@http@response:response(GGD)),
    fun((GGD) -> GGF)
) -> fun((GGC) -> gleam@http@response:response(GGF)).
...
-spec prepend_response_header(
    fun((GGH) -> gleam@http@response:response(GGI)),
    binary(),
    binary()
) -> fun((GGH) -> gleam@http@response:response(GGI)).
...
-spec ensure_post(gleam@http@request:request(GGL)) -> {ok,
        gleam@http@request:request(GGL)} |
    {error, nil}.
ensure_post(Req) ->
...
-spec method_override(fun((gleam@http@request:request(GGU)) -> GGW)) -> fun((gleam@http@request:request(GGU)) -> GGW).
