...
-spec fragment(list(lustre@vdom@vnode:element(QIA))) -> lustre@vdom@vnode:element(QIA).
fragment(Children) ->
...
-spec memo(
    ...
    fun(() -> lustre@vdom@vnode:element(QIJ))
...
-spec map(lustre@vdom@vnode:element(QIN), fun((QIN) -> QIP)) -> lustre@vdom@vnode:element(QIP).
map(Element, F) ->
