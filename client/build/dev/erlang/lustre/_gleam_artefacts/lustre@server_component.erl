...
-spec element(
    list(lustre@vdom@vattr:attribute(XUC)),
    list(lustre@vdom@vnode:element(XUC))
) -> lustre@vdom@vnode:element(XUC).
...
-spec include(lustre@vdom@vattr:attribute(XUO), list(binary())) -> lustre@vdom@vattr:attribute(XUO).
...
-spec subject(lustre:runtime(XUS)) -> gleam@erlang@process:subject(lustre@runtime@server@runtime:message(XUS)).
subject(Runtime) ->
...
-spec register_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(XVA))
) -> lustre@runtime@server@runtime:message(XVA).
...
-spec deregister_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(XVE))
) -> lustre@runtime@server@runtime:message(XVE).
...
-spec register_callback(
    fun((lustre@runtime@transport:client_message(XVI)) -> nil)
) -> lustre@runtime@server@runtime:message(XVI).
...
-spec deregister_callback(
    fun((lustre@runtime@transport:client_message(XVL)) -> nil)
) -> lustre@runtime@server@runtime:message(XVL).
...
-spec select(
    fun((fun((XVQ) -> nil), gleam@erlang@process:subject(any())) -> gleam@erlang@process:selector(XVQ))
) -> lustre@effect:effect(XVQ).
select(Sel) ->
