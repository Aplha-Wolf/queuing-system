...
-spec find_matching_in_list(
    list(lustre@vdom@vnode:element(VOF)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(VOF), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_direct_child(
    ...
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(VOA), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_all_matching_in_list(
    list(lustre@vdom@vnode:element(VPN)),
    selector()
) -> list(lustre@vdom@vnode:element(VPN)).
...
-spec find_all_direct_children(lustre@vdom@vnode:element(VPJ), selector()) -> list(lustre@vdom@vnode:element(VPJ)).
...
-spec find_all_in_list(list(lustre@vdom@vnode:element(VPE)), 'query'()) -> list(lustre@vdom@vnode:element(VPE)).
...
-spec find_all(lustre@vdom@vnode:element(VOW), 'query'()) -> list(lustre@vdom@vnode:element(VOW)).
find_all(Root, Query) ->
    case Query of
        {find_element, Selector} ->
...
-spec find_all_in_children(lustre@vdom@vnode:element(VPA), 'query'()) -> list(lustre@vdom@vnode:element(VPA)).
...
-spec find_all_descendants(lustre@vdom@vnode:element(VPS), selector()) -> list(lustre@vdom@vnode:element(VPS)).
...
-spec find_in_list(
    ...
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(VNU), lustre@vdom@path:path()}} |
    {error, nil}.
...
?DOC(false).
-spec find_path(
    lustre@vdom@vnode:element(VNK),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(VNK), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_in_children(
    lustre@vdom@vnode:element(VNP),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(VNP), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find(lustre@vdom@vnode:element(VNF), 'query'()) -> {ok,
        lustre@vdom@vnode:element(VNF)} |
    {error, nil}.
find(Root, Query) ->
...
-spec find_descendant_in_list(
    list(lustre@vdom@vnode:element(VOQ)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(VOQ), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_descendant(
    lustre@vdom@vnode:element(VOL),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(VOL), lustre@vdom@path:path()}} |
    {error, nil}.
